      ...
      <div class="row mt-lg-n10 mt-md-n11 mt-n10">
        <div class="col-xl-7 col-lg-7 col-md-9 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="{{ route('org.category-management-update', $data->slug) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-3">
                  <label for="name" class="form-label">Category Name</label>
                  <input type="text" class="form-control" placeholder="Category Name" name="name" id="name" aria-label="Name" aria-describedby="name" value="{{ old('name', $data->name) }}">
                  @error('name')
                ...
                <div class="mb-3">
                  <input disabled type="text" class="form-control" placeholder="Category Slug" name="slug" id="slug" aria-label="Slug" aria-describedby="slug" value="{{ old('slug', $data->slug) }}">
                </div>
